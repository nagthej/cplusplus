...
//Default constructor definition - Does nothing and initialises param to ZERO
Birthday::Birthday(): year(0), month(0), day(0)
{
	//Empty body
}

//Constructor definition - This constructor initialises member variables to a value
